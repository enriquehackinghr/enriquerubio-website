...
export default function BookLanding() {
  return (
    ...
    >
      ...
      {/* Two promo images side by side */}
      <div className="flex flex-row w-full">
        <div className="flex-1 overflow-hidden">
          <img src="/oea-promo.png" alt="Our Existential Advantage — Available Now" className="w-full block" />
        </div>
        <div className="flex-1 overflow-hidden">
          <img src="/aib-promo.png" alt="AI for Beginners — Available Now" className="w-full block" />
        </div>
      </div>

      {/* Content below images */}
      <div className="flex-1 flex flex-col justify-center px-8 md:px-14 py-10 max-w-3xl">
        ...
        {/* Headline */}
        <h1
          className="uppercase leading-[0.88] mb-8"
          style={{
        ...
        {/* Two book entries */}
        <div className="flex flex-col gap-3 mb-8" style={{ maxWidth: "640px" }}>
          <a
